...
uses SysUtils, Classes, Graphics, Controls, Forms, Dialogs, StdCtrls, ComCtrls,
  ZRPrntr, Buttons;
...
begin
  Caption       := szrPrinting;
  Cancel.Caption:= szrCancel;
end;

procedure TZRProgressForm.FormClose(Sender: TObject; var AAction: TCloseAction);
begin
  AAction := caFree;
end;
...
begin
  ...
  Info .Caption  := IntToStr(Value)+'% ' + szrCompleted;
end;
