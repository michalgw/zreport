...
begin
  ...
  case Index of
    ...
    2: TZReportFake(Report).Minimized := not TZReportFake(Report).Minimized;
  end;
end;
...
const
  MIN_CAPTIONS: array[Boolean] of String = ('Minimize', 'Restore');
var
  Report : TZReport;
begin
  Report := (Component as TZReportControl).Report;
  case Index of
    ...
    2  : Result := MIN_CAPTIONS[TZReportFake(Report).Minimized];
    else Result := '';
  end;
end;
